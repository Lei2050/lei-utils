...
func TestProxy(t *testing.T) {
	...
	proxy.SendHttpRequest(&HttpRequest{HTTP_METHOD_GET,
		"http://127.0.0.1:9090/sayhello?a=123&b=100",
		nil,
	...
	proxy.SendRequest(HTTP_METHOD_GET,
	...
	proxy.SendRequestWithCallback(HTTP_METHOD_POST,
